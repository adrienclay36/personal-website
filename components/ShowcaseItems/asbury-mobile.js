...
const AsburyMobile = () => {
  ...
  return (
    <div
      ...
      className="container bg-white rounded-lg shadow-lg shadow-gray-300 p-10 mb-12 lg:mb-40 md:mb-40 w-11/12 lg:w-full md:w-11/12"
    >
